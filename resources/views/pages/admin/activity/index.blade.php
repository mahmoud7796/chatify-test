        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="height: 50px">
                    النشاطات
                    <span class="pull-left"><a href="{{ route('admin.activity.create') }}" class="btn btn-primary btn-sm"><i
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <div>
                                            ...
                                            <form class="pull-left" action="{{ route('admin.activity.destroy', $timeline) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <p>
