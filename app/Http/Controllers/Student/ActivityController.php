...
class ActivityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.student.activity.index', compact('timelines', 'activities'));
    }
    ...
    {
        return view('pages.student.activity.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('student.activity.index')->with([
            'message' => [
                'type' => 'success',
