...
class ActivityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.teacher.activity.index', compact('timelines', 'activities'));
    }
    ...
    {
        return view('pages.teacher.activity.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.activity.index')->with([
            'message' => [
                'type' => 'success',
